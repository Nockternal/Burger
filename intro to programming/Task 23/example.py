...
# Programmers have already written the logic for many common and even complex tasks, and sometimes you can find the exact built-in function that you need to complete a task.
